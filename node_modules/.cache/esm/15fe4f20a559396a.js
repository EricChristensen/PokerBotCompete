let _,c;_a55‍.x([["default",()=>Range]]);_a55‍.w("lodash",[["default",["_"],function(v){_=v}]]);_a55‍.w("../constants",[["default",["c"],function(v){c=v}]]);/*
  Deserializes ranges.
*/
  ...
  get(deadCards = []) {
    ...
    function handOkay(hand) {
      return deadCards.indexOf(hand[0]) === -1 && deadCards.indexOf(hand[1]) === -1;
    }
  ...
  initRankOnlyPlusHand() {
    ...
    let secondCardRankRange = c.RANKS.slice(c.RANK_INDEX[cards[1]], c.RANK_INDEX[cards[0]]);
