let c,Simulator;_c9e‍.x([["default",()=>Player]]);_c9e‍.w("./constants",[["default",["c"],function(v){c=v}]]);_c9e‍.w("pokery",[["default",["Simulator"],function(v){Simulator=v}]]);
...
const { raceRange, rates, raceRangeForBoard } = require('pec')
    ...
    */
    equity() {
        ...
        _c9e‍.g.console.log('win: %d%% (%d times)', winRate, win)
        _c9e‍.g.console.log('loose: %d%% (%d times)', looseRate, loose)
        _c9e‍.g.console.log('tie: %d%% (%d times)', tieRate, tie)
    ...
    decisionResponse(winRate, loseRate, amountToWin, amountToLose) {
        _c9e‍.g.console.log("win rate: " + winRate + " loseRate " + loseRate);
    ...
    fullRange(oldRange) {
        ...
        oldRange.forEach(function(element) {
            if (element.length == 2) { //suited or unsuited
                ...
                _c9e‍.g.console.log(element.length)
            }
        });
        return eRange;
    }
