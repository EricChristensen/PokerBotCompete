...
describe('Range.constructor', () => {
  ...
  it('generates rank only hands', () => {
    ...
    let expectedHands = [['Ac', 'Qc'], ['Ac', 'Qd'], ['Ac', 'Qh'], ['Ac', 'Qs'], ['Ah', 'Qc'], ['Ah', 'Qd'], ['Ah', 'Qh'], ['Ah', 'Qs'], ['Ad', 'Qc'], ['Ad', 'Qd'], ['Ad', 'Qh'], ['Ad', 'Qs'], ['As', 'Qc'], ['As', 'Qd'], ['As', 'Qh'], ['As', 'Qs']];
  ...
  it('generates rank only plus hands', () => {
    ...
    let expectedHands = [['Ac', 'Jc'], ['Ac', 'Jd'], ['Ac', 'Jh'], ['Ac', 'Js'], ['Ah', 'Jc'], ['Ah', 'Jd'], ['Ah', 'Jh'], ['Ah', 'Js'], ['Ad', 'Jc'], ['Ad', 'Jd'], ['Ad', 'Jh'], ['Ad', 'Js'], ['As', 'Jc'], ['As', 'Jd'], ['As', 'Jh'], ['As', 'Js'], ['Ac', 'Qc'], ['Ac', 'Qd'], ['Ac', 'Qh'], ['Ac', 'Qs'], ['Ah', 'Qc'], ['Ah', 'Qd'], ['Ah', 'Qh'], ['Ah', 'Qs'], ['Ad', 'Qc'], ['Ad', 'Qd'], ['Ad', 'Qh'], ['Ad', 'Qs'], ['As', 'Qc'], ['As', 'Qd'], ['As', 'Qh'], ['As', 'Qs'], ['Ac', 'Kc'], ['Ac', 'Kd'], ['Ac', 'Kh'], ['Ac', 'Ks'], ['Ah', 'Kc'], ['Ah', 'Kd'], ['Ah', 'Kh'], ['Ah', 'Ks'], ['Ad', 'Kc'], ['Ad', 'Kd'], ['Ad', 'Kh'], ['Ad', 'Ks'], ['As', 'Kc'], ['As', 'Kd'], ['As', 'Kh'], ['As', 'Ks']];
  ...
  it('generates offsuit hands', () => {
    ...
    let expectedHands = [['9c', '3d'], ['9c', '3h'], ['9c', '3s'], ['9h', '3c'], ['9h', '3d'], ['9h', '3s'], ['9d', '3c'], ['9d', '3h'], ['9d', '3s'], ['9s', '3c'], ['9s', '3d'], ['9s', '3h']];
  ...
  it('generates offsuited plus hands', () => {
    ...
    let expectedHands = [['Ac', 'Jd'], ['Ac', 'Jh'], ['Ac', 'Js'], ['Ah', 'Jc'], ['Ah', 'Jd'], ['Ah', 'Js'], ['Ad', 'Jc'], ['Ad', 'Jh'], ['Ad', 'Js'], ['As', 'Jc'], ['As', 'Jd'], ['As', 'Jh'], ['Ac', 'Qd'], ['Ac', 'Qh'], ['Ac', 'Qs'], ['Ah', 'Qc'], ['Ah', 'Qd'], ['Ah', 'Qs'], ['Ad', 'Qc'], ['Ad', 'Qh'], ['Ad', 'Qs'], ['As', 'Qc'], ['As', 'Qd'], ['As', 'Qh'], ['Ac', 'Kd'], ['Ac', 'Kh'], ['Ac', 'Ks'], ['Ah', 'Kc'], ['Ah', 'Kd'], ['Ah', 'Ks'], ['Ad', 'Kc'], ['Ad', 'Kh'], ['Ad', 'Ks'], ['As', 'Kc'], ['As', 'Kd'], ['As', 'Kh']];
  ...
  it('generates suited hands', () => {
    ...
    const expectedHands = [['Ac', 'Qc'], ['Ad', 'Qd'], ['Ah', 'Qh'], ['As', 'Qs']];
  ...
  it('generates suited plus hands', () => {
    ...
    let expectedHands = [['Ac', 'Jc'], ['Ah', 'Jh'], ['Ad', 'Jd'], ['As', 'Js'], ['Ac', 'Qc'], ['Ah', 'Qh'], ['Ad', 'Qd'], ['As', 'Qs'], ['Ac', 'Kc'], ['Ah', 'Kh'], ['Ad', 'Kd'], ['As', 'Ks']];
    assert.equal(range.hands.length, 12);
    assertArrayEqual(range.hands, expectedHands);
  ...
  it('generates pocket pair hands', () => {
    ...
    let expectedHands = [['5c', '5d'], ['5c', '5h'], ['5c', '5s'], ['5d', '5h'], ['5d', '5s'], ['5h', '5s']];
  ...
  it('generates pocket pair range hands', () => {
    ...
    let expectedHands = [['5c', '5d'], ['5c', '5h'], ['5c', '5s'], ['5d', '5h'], ['5d', '5s'], ['5h', '5s'], ['6c', '6d'], ['6c', '6h'], ['6c', '6s'], ['6d', '6h'], ['6d', '6s'], ['6h', '6s'], ['7c', '7d'], ['7c', '7h'], ['7c', '7s'], ['7d', '7h'], ['7d', '7s'], ['7h', '7s'], ['8c', '8d'], ['8c', '8h'], ['8c', '8s'], ['8d', '8h'], ['8d', '8s'], ['8h', '8s']];
  ...
  it('generates pocket pair plus hands', () => {
    ...
    let expectedHands = [['Qc', 'Qd'], ['Qc', 'Qh'], ['Qc', 'Qs'], ['Qd', 'Qh'], ['Qd', 'Qs'], ['Qh', 'Qs'], ['Kc', 'Kd'], ['Kc', 'Kh'], ['Kc', 'Ks'], ['Kd', 'Kh'], ['Kd', 'Ks'], ['Kh', 'Ks'], ['Ac', 'Ad'], ['Ac', 'Ah'], ['Ac', 'As'], ['Ad', 'Ah'], ['Ad', 'As'], ['Ah', 'As']];
  ...
  it('concatenates multiple ranges', () => {
    ...
    let expectedHands = [['Ac', 'Qc'], ['Ac', 'Qd'], ['Ac', 'Qh'], ['Ac', 'Qs'], ['Ah', 'Qc'], ['Ah', 'Qd'], ['Ah', 'Qh'], ['Ah', 'Qs'], ['Ad', 'Qc'], ['Ad', 'Qd'], ['Ad', 'Qh'], ['Ad', 'Qs'], ['As', 'Qc'], ['As', 'Qd'], ['As', 'Qh'], ['As', 'Qs'], ['9c', '3d'], ['9c', '3h'], ['9c', '3s'], ['9h', '3c'], ['9h', '3d'], ['9h', '3s'], ['9d', '3c'], ['9d', '3h'], ['9d', '3s'], ['9s', '3c'], ['9s', '3d'], ['9s', '3h'], ['5c', '5d'], ['5c', '5h'], ['5c', '5s'], ['5d', '5h'], ['5d', '5s'], ['5h', '5s']];
...
describe('Range.get', () => {
  ...
  it('factors in dead cards', () => {
    const range = new Range('QQ');
    const expectedHands = [['Qc', 'Qd'], ['Qc', 'Qh'], ['Qd', 'Qh']];
    for (var i = 0; i < 6; i++) {
